...
<title>Welcome to the Bus Seat Reservation System</title>
...
<form class="ui form attached fluid loading segment" method="POST">
 ...
 <input type="submit" name="login" class="ui purple submit button" tabindex=3 value="Login!"> 
</div>
</form>

<div class="ui bottom attached warning message">
<i class="icon help"></i> Use <a href="#0"> admin</a> as username and password as <a href="#">password</a> to access.
</div>
