      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="active item" href="bookings.php">Reservations</a><a class="item" href="transactions.php">Transactions</a><a class="item" href="travelclass.php">Seat Class</a>
          </div>
        </div>
...
<thead><tr><th>#Order ID</th><th>Customer Name</th><th>Contact</th><th>Class Reserved</th><th>Destination</th><th>#No Seats</th><th>Travel Date</th><th>Operation</th></tr></thead>
<tbody>
<?php
require("../dbengine/dbconnect.php");
