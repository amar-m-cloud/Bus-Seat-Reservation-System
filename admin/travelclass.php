      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="item" href="bookings.php">Reservations</a><a class="item " href="transactions.php">Transactions</a><a class="active item" href="travelclass.php">Traveling Classes</a>
          </div>
        </div>
