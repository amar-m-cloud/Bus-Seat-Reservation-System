...
<title>Generating Your Order...</title>
...
<div class="content">
<div class="header">Loading, please stand by</div>
<div id="proceed"></div>
</div>
</div>
...
<button id="printbtn" class="ui button small black">Re-print</button>
</form>
...
<script>
setTimeout(function(){$('#proceed').siblings().hide();$('.gload').hide();document.getElementById("proceed").innerHTML="<a href='booking.php' class='ui button small red'>Make New Reservation</a> <a href='../admin/login.php' class='ui button small purple'>Admin Login</a> "},5000);
</script>
</body>
</html>